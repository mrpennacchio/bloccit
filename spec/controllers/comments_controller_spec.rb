...
RSpec.describe CommentsController, type: :controller do
  ...
  # specs for guest users who will redirect to sign in if they try to create ro delete a comment
  context "guest" do
  ...
  # member users who attempt to create or delete comments they down own. . allow to create, but redirect if they try to delete
  context "member using CRUD on a comment they down own" do
    before do
  ...
  #test that members users are able to create and delete their own comments
  context "mmber user doing CRUD on a comment they own" do
    before do
  ...
  # admin users can create and delete any comment
